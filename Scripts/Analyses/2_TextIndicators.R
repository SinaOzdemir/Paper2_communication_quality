...
# All text indicators only extracted for english sentences in the tweets (text.en)
...
# Corpus ####
corpus <- read_rds("./tweetcorpora/EUtweets_cleaned.RDS")
...
qcorp <- corpus(df$text.en, docvars = data.frame(corpus[, "status_id"]))
