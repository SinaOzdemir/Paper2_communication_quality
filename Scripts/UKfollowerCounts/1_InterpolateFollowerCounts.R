#####################################################################
# Project:  EU Tweet
# Task:     Interpolate UK follower counts (collected from archive.org)
...
# Required lists ####
files <- paste0("./data/FollowerCounts/UK/",
                list.files("./data/FollowerCounts/UK/")) # Files with info on individual profiles
accounts <- read_rds("./analysis_data/UK_account_list.RDS") # EU account info
snapshots <- read_rds("./analysis_data/UK-snapshots.RDS") # Info on avilable archive.org snapshots
...
write_rds(followercounts, "./analysis_data/FollowerCountsInterpolated_UK.RDS")
